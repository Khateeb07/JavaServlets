...
public class Session1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action=\"sess2\" method=\"POST\" class=\"row justify-content-center\">");
            ...
            out.println("<input type='hidden' name='fname' value='"+fn+"'/>");
            out.println("<input type='hidden' name='lname' value='"+ln+"'/>");
